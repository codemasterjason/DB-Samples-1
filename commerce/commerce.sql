...
-- -----------------------------------------------------
-- Data for table `commerce`.`store`
-- -----------------------------------------------------
START TRANSACTION;
USE `commerce`;
INSERT INTO `commerce`.`store` (`id`, `product_id`, `quantity`, `discount`, `valid_from`, `valid_to`, `hide`, `created_at`, `updated_at`) VALUES (1, 1, 10, 10000, '2016-05-01', '2016-06-01', 'N', DEFAULT, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `commerce`.`notice`
-- -----------------------------------------------------
START TRANSACTION;
USE `commerce`;
INSERT INTO `commerce`.`notice` (`id`, `title`, `body`, `created_at`, `updated_at`) VALUES (1, 'Test', 'Hello', DEFAULT, DEFAULT);
